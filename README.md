...
| 역할 | 이름 | 분담                                                                                                                                                                                                                                                                                                                                                                                      |
| --- | --- |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Spring | 류시영 | ‣ 반려동물<br>   - 반려동물 등록, 조회, 수정, 삭제<br>  ‣ 반려동물 이미지<br> - 등록, 수정 삭제<br>   ‣ 반려동물 좋아요<br> - 등록, 삭제<br>   ‣ 페이지네이션,무한스크롤 구현<br>‣ 테스트서버 (http)<br>   - AWS EC2, RDS(MySQL), S3<br>‣ 스케쥴링 서비스 로직                                                                                                                                                                                                                                                   |
