...
public class WebConfig implements WebMvcConfigurer {
    ...
    private static final String REACT_LOCAL_HOST3= "https://final-five-pied.vercel.app";
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                ...
                .allowedOrigins(REACT_LOCAL_HOST, REACT_LOCAL_HOST2, REACT_LOCAL_HOST3, PRODUCTION_HOST, PRODUCTION_HOST2, PRODUCTION_HOST3)
