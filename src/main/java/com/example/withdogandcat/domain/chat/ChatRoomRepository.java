...
public class ChatRoomRepository {
    ...
    public ChatRoom createChatRoom(String name, User creator) {
        ChatRoom chatRoom = ChatRoom.create(name, creator);
    ...
    public void deleteChatRoom(String roomId, Long userId) {
        ...
        if (!chatRoom.getCreator().getUserId().equals(userId)) {
            throw new IllegalStateException("You do not have permission to delete this chat room.");
        }
