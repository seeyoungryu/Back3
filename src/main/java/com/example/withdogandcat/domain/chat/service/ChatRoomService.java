...
public class ChatRoomService {
    ...
    private final int MAX_ROOM_COUNT = 30;

    @Transactional
    public BaseResponse<ChatRoomEntity> createChatRoom(String name, String userEmail) {
        ...
        return new BaseResponse<>(BaseResponseStatus.SUCCESS, "성공", chatRoomEntity);
    }
    ...
    public BaseResponse<Void> deleteChatRoom(String roomId, String userEmail) {
        ...
        if (!chatRoomEntity.getCreatorId().getEmail().equals(userEmail)) {
            return new BaseResponse<>(BaseResponseStatus.INVALID_TOKEN, "실패", null);
        }
    ...
    public BaseResponse<List<ChatRoomListDto>> findAllRoomListDtos() {
        ...
        return new BaseResponse<>(BaseResponseStatus.SUCCESS, "성공", chatRoomListDtos);
    }
